...
Log.Logger = new LoggerConfiguration()
    ...
    .Enrich.WithProperty("ServiceName", "RoomService")
...
try
{
    Log.Information("Starting Room Service...");
    ...
    builder.Services.AddHttpClient<IRoomManagementService, RoomManagementService>();
    ...
    builder.Services.AddSwaggerGen(c =>
    {
        ...
        { 
            ...
            Version = "v1",
            Description = "Microservice for managing hotel rooms"
        });
...
{
    Log.Fatal(ex, "Room Service failed to start");
}
finally
{
    Log.CloseAndFlush();
